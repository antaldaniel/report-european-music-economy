...
_To quote the task description_:
...
2.  _Indicators that bring transparency to music streaming and zero-marginal-price (free) uses of music are developed, as well as indicators about the economic contributions of music to the national economy._ This is the subject of this main document, and can be found [here](https://music.dataobservatory.eu/documents/open_music_europe/economy/report/economy_music_data_indicators.html) in html, pdf, docx, epub formats.

3.  _A market comparator model for valuing public performance and free uses, such as representative music streams (based on CEEMID ‘full market model’ and a DCF model) is developed._ This is a **separate document**: [A Market Comparator Model for Valuing the Use of Music](https://music.dataobservatory.eu/documents/open_music_europe/economy/market-comparators-model/comparators.html). We need to summarise this document in D1.1, but to me it is rather different.
