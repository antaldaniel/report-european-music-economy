---
title: "Data coordination and indicator methodology for Open Music Europe"
subtitle: "Background document for: Economy of music in Europe: Novel data collection methods and indicators"
author: "Daniel Antal"
toc: true
lang: en-GB
date: today
...
1.  *The methods and indicators will be presented in D1.1.* Because the same indicator development methodology is used in `WP1`, `WP2`, `WP3` and `WP4`, this is part of a **separate document** which defines the entire data-to-policy pipeline, i.e., the main objective of the grant. [Data Pillars in the Open Music Observatory](https://music.dataobservatory.eu/documents/open_music_europe/data-to-policy/music-observatory-pillars.html) (html, pdf, docx, epub). If we need more details in D1.1 we can bring over from that document.

2.  *Indicators that bring transparency to music streaming and zero-marginal-price (free) uses of music are developed, as well as indicators about the economic contributions of music to the national economy.* This is the subject of this main document, and can be found [here](https://music.dataobservatory.eu/documents/open_music_europe/economy/report/economy_music_data_indicators.html) in html, pdf, docx, epub formats.

3.  *A market comparator model for valuing public performance and free uses, such as representative music streams (based on CEEMID 'full market model' and a DCF model) is developed.* This is a **separate document**: [A Market Comparator Model for Valuing the Use of Music](https://music.dataobservatory.eu/documents/open_music_europe/economy/market-comparators-model/comparators.html). We need to summarise this document in D1.1, but to me it is rather different.
:::
